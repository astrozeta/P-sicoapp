    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-brand-500 selection:text-white flex">
      ...
      <main className="flex-1 md:pl-64 flex flex-col min-h-screen">
         ...
         <div className="p-6 flex-1 overflow-y-auto">
            ...
            {currentView === 'psych-dashboard' && <PsychologistDashboard user={user} activeSection={psychView} onSectionChange={setPsychView} />}
      ...
      <MobileNav currentView={currentView} onChangeView={setCurrentView} role={user.role} />
